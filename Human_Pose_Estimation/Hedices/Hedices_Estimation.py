...
# PoseModelPath = '/app/appexample/yolov5s6_pose_640_ti_lite_54p9_82p2.onnx'
# VideoPath = '/app/static/p.mp4'
...
def inference_pose(model_path, img, mean=None, scale=None, conf_thres=0.3):
    ...
    # 推理
    session = onnxruntime.InferenceSession(model_path, provider=['CPUExecutionProvider'])
